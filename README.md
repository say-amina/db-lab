...
### Student Details
* **Name:** Amina  
* **Course:** Database Systems (BSAI-2025)  
...
2. I understood that Git acts like a powerful time-machine that tracks code history far better than Google Drive.
3. I mastered the basics of committing changes, which allows developers to save incremental versions of their work safely.
